"""Read a saved run: what the model was shown, what it asked for, what code did.
    ...
    python -m tools.show_run                     # the most recent run
    python -m tools.show_run runs/disc_4baf0086
    python -m tools.show_run runs/run_1a2b3c4d   # a replay run reads the same way
"""
