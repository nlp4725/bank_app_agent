"""Apply the Reviewer's decisions file to a draft, then approve only if it verifies.

    python -m tools.authoring.approve runs/disc_7ec36ab5

The scripted form of the review: the decisions come from `artifacts/*.decisions.yaml`
rather than from questions at the prompt.
"""
...
def main():
    ...
    draft, suggestions = record_from_run(
        run_dir, CONTRACT, EXAMPLE_VALUES,
