...
![read_savings_balance under four runs](./figures/read_savings_balance_paths.svg)
...
The redaction chain of [docs/discovery.md](./discovery.md) and REPORT §6 as a list; here every layer with the threat it counters, who
