...
_ARTIFACT = {
    ...
    # One State per step, one Checkpoint per State (ADR 0007): each is what the
    # previous action must have achieved, so every step is verified before the next.
    "states": [
        {"id": "sign_in", "checkpoint": {"type": "element_present", "target": "t_user"}},
        {"id": "user_entered", "checkpoint": {"type": "field_value", "target": "t_user", "non_empty": True}},
        {"id": "password_entered", "checkpoint": {"type": "field_value", "target": "t_password", "non_empty": True}},
        {"id": "search_ready", "checkpoint": {"type": "element_present", "target": "t_member_field"}},
        {"id": "member_entered", "checkpoint": {"type": "field_value", "target": "t_member_field", "non_empty": True}},
        ...
        {"id": "form_open", "checkpoint": {"type": "element_present", "target": "t_acct_type"}},
        {"id": "type_selected", "checkpoint": {"type": "field_value", "target": "t_acct_type", "non_empty": True}},
        {"id": "nickname_entered", "checkpoint": {"type": "field_value", "target": "t_nickname", "non_empty": True}},
        {"id": "review_shown", "checkpoint": {"type": "text_present", "value": "Review sub-account"}},
        {"id": "done", "checkpoint": {"type": "text_present", "value": "Confirmation"}},
        {"id": "number_read", "terminal": "succeeded",
         "checkpoint": {"type": "element_present", "target": "t_new_number"}},
    ],
    "transitions": [
        {"from_state": "sign_in", "to_state": "user_entered", "risk": "safe",
         "action": {"type": "type", "target": "t_user", "value_ref": "login_username"}},
        {"from_state": "user_entered", "to_state": "password_entered", "risk": "safe",
         "action": {"type": "type", "target": "t_password", "value_ref": "login_password"}},
        {"from_state": "password_entered", "to_state": "search_ready", "risk": "safe",
         "action": {"type": "click", "target": "t_signin"}},
        {"from_state": "search_ready", "to_state": "member_entered", "risk": "safe",
         "action": {"type": "type", "target": "t_member_field", "value": "{{member_number}}"}},
        {"from_state": "member_entered", "to_state": "member_open", "risk": "safe", "timeout_ms": 8000,
        ...
        {"from_state": "form_open", "to_state": "type_selected", "risk": "safe",
         "action": {"type": "select", "target": "t_acct_type", "value": "{{account_type}}"}},
        {"from_state": "type_selected", "to_state": "nickname_entered", "risk": "safe",
         "action": {"type": "type", "target": "t_nickname", "value": "{{nickname}}"}},
        {"from_state": "nickname_entered", "to_state": "review_shown", "risk": "safe",
        ...
        {"from_state": "done", "to_state": "number_read", "risk": "safe",
